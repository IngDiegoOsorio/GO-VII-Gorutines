...
func proceso(id uint64, imprimirValores chan bool, cerrarProcesoID chan uint64) {
	...
	for {
		...
		if msgImprimirValor {
			fmt.Printf("Proceso ID:%d  Valor:%d\n", id, i)
		}
...
func menu (){
	...
	fmt.Println("2. Imprimir Procesos")
...
func main() {
	...
	for opcion != 4{
		...
		case 3:
			fmt.Print("Digite El ID Del Proceso Que Desea Eliminar: ")
		...
		default:
			fmt.Println("Error Opcion Incorrecta, Intente De Nuevo")
		}
	}
